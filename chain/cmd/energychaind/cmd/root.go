...
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		...
		PersistentPreRunE: func(cmd *cobra.Command, _ []string) error {
			...
			customAppTemplate, customAppConfig := config.InitAppConfig(evmd.NativeDenom, evmd.EVMChainID)
...
func initCometConfig() *cmtcfg.Config {
	...
	// Use the app-side mempool by default so validators stay on the
	// deadlock-free app/exclusive path unless operators opt out explicitly.
